...
export const pt = {
  ...
  textTooLong: 'Texto muito longo',
  priceMustBePositive: 'Preço deve ser positivo',
  durationMustBeInteger: 'Duração deve ser um número inteiro',
  ...
  atLeastOneService: 'Selecione pelo menos um serviço',
  
  // Page descriptions
  bookingsDescription: 'Gerencie seus agendamentos',
  clientsDescription: 'Gerencie seus clientes',
  servicesDescription: 'Gerencie seus serviços',
  professionalsDescription: 'Gerencie seus profissionais',
  settingsDescription: 'Configure sua loja',
  ...
  // Booking (public page)
  bookingTitle: 'Agendar Horário',
  bookingSubtitle: 'Escolha os serviços desejados',
  ...
  bookingSuccessMessage: 'Você receberá uma confirmação em breve.',
  ...
  errorCreatingBooking: 'Erro ao criar agendamento',
  ...
  noProfessionalsAvailable: 'Nenhum profissional disponível',
  bookNewAppointment: 'Agendar novo horário',
  stepServices: 'Serviços',
  stepProfessional: 'Profissional',
  stepDateTime: 'Data/Hora',
  stepInfo: 'Seus Dados',
  ...
  // Errors
  errorConflict: 'Horário já ocupado',
  errorNoSlots: 'Não há horários disponíveis',
  errorUpload: 'Erro ao enviar foto',
  ...
  businessHoursSaved: 'Horário de funcionamento salvo',
  errorSavingBusinessHours: 'Erro ao salvar horário de funcionamento',
  slugSaved: 'URL da loja salva',
  slugTaken: 'Esta URL já está em uso',
  invalidSlug: 'URL inválida. Use apenas letras minúsculas, números e hífens.',
  errorSavingSlug: 'Erro ao salvar URL da loja',
  storeName: 'Nome da loja',
  storeSlug: 'URL da loja',
  storeSlugHelp: 'Sua página de agendamento ficará em: ',
  storePhone: 'Telefone',
  storeEmail: 'Email',
  storeAddress: 'Endereço',
  storeLogo: 'Logo da loja',
  bookingSettings: 'Configurações de agendamento',
  slotDuration: 'Duração do slot',
  maxPhotosPerAppointment: 'Máximo de fotos por agendamento',
  allowMultipleSameService: 'Permitir mesmo serviço múltiplas vezes',
  allowMultipleSameServiceHelp: 'Permite agendar o mesmo serviço mais de uma vez no mesmo atendimento',
  requirePhoneForBooking: 'Exigir telefone para agendamento',
  requirePhoneForBookingHelp: 'O cliente precisará informar o telefone ao fazer uma reserva',
  showPricesPublicly: 'Exibir preços na página pública',
  showPricesPubliclyHelp: 'Os preços dos serviços serão visíveis na página de agendamento',
  minutes: 'minutos',
  enabled: 'ativado',
  ...
  dashboardDescription: 'Visão geral da sua loja',
  ...
  viewAllAppointments: 'Ver todos os agendamentos',
  quickActions: 'Ações rápidas',
  viewReports: 'Ver relatórios',
  
  // Schedule Overrides
  scheduleOverride: 'Exceção de horário',
  scheduleOverrides: 'Exceções de horário',
  addOverride: 'Adicionar exceção',
  editOverride: 'Editar exceção',
  removeOverride: 'Remover exceção',
  overrideType: 'Tipo',
  workOnThisDay: 'Trabalhar neste período',
  dayOff: 'Folga/Ausência',
  overrideReason: 'Motivo',
  reasonVacation: 'Férias',
  reasonSickLeave: 'Atestado médico',
  reasonPersonal: 'Motivo pessoal',
  reasonSpecialEvent: 'Evento especial',
  reasonClientRequest: 'Pedido de cliente',
