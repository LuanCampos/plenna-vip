...
export const en = {
  ...
  noProfessionalsAvailable: 'No professionals available',
  ...
  errorSavingBusinessHours: 'Error saving business hours',
  slugSaved: 'Store URL saved',
  slugTaken: 'This URL is already taken',
  invalidSlug: 'Invalid URL. Use only lowercase letters, numbers, and hyphens.',
  errorSavingSlug: 'Error saving store URL',
  storeName: 'Store name',
  storeSlug: 'Store URL',
  storeSlugHelp: 'Your booking page will be at: ',
  storePhone: 'Phone',
  storeEmail: 'Email',
  ...
  maxPhotosPerAppointment: 'Maximum photos per appointment',
  allowMultipleSameService: 'Allow same service multiple times',
  allowMultipleSameServiceHelp: 'Allows booking the same service more than once in the same appointment',
  requirePhoneForBooking: 'Require phone for booking',
  requirePhoneForBookingHelp: 'Customer must provide phone number when booking',
  showPricesPublicly: 'Show prices on public page',
  showPricesPubliclyHelp: 'Service prices will be visible on the booking page',
  minutes: 'minutes',
  enabled: 'enabled',
  ...
  dashboardDescription: 'Overview of your store',
